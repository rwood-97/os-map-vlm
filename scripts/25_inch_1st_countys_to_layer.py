...
# layer names to XYZ URLs (dict deduplicates any repeated entries)
...
regional_layers = {
    ...
    # Scotland (all → scotland_1 for now)
    "lanarkshire": "os25scotland",
    "linlithgowshire": "os25scotland",
    "stirlingshire": "os25scotland",
    "renfrewshire": "os25scotland",
    "aberdeenshire": "os25scotland",
    "argyllshire": "os25scotland",
    "ayrshire": "os25scotland",
    "banffshire": "os25scotland",
