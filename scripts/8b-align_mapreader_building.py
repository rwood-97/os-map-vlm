"""
Align MapReader building predictions (LwM MapReader_Outputs_SIGSPATIAL_2022) to
...
finds MapReader "building" squares whose polygon overlaps the patch bounding
...
Usage:
  uv run python scripts/8b-align_mapreader_building.py \\
      --patches-dir data/patches_6inch_2nd_ed \\
      --predictions predictions_building_geo.csv \\
...
def main():
    ...
    parser.add_argument(
        "--predictions",
        required=True,
        help="Path to predictions_building_geo.csv",
    )
    parser.add_argument(
        "--output",
