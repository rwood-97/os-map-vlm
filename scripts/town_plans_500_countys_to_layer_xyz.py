...
town_plans_500_tilelayers = tilelayers[tilelayers["Typename"]=="nls:OS_Town_Plans_Eng_500_WFS"]
town_plans_500_tilelayers = town_plans_500_tilelayers[~town_plans_500_tilelayers["Name"].str.startswith("R_")]
layers = town_plans_500_tilelayers["Name"].tolist()

# Additional layers not in the 500 WFS typename
layers.extend(['OSTowns_Guildford', 'OSTowns_Hitchin', 'edin1849', 'edin1893', 'glas1857'])
...
regional_layers = [
    'OSTowns_Wales', 'OSTowns_Cornwall', 'OSTowns_Isle_of_Man',
    'OSTowns_North', 'OSTowns_South', 'OSTowns_Midlands_east', 'OSTowns_Midlands_west',
    'TownsBirmimgham1855',
]
...
for name, layer_name in [
    (['glamorgan', 'monmouth', 'caernarvon', 'carnarvon', 'carmarthen', 'pembroke', 'denbigh', 'flint', 'merioneth', 'cardigan', 'brecon', 'brecknock', 'radnor', 'anglesey', 'anglesea', 'montgomery'], 'OSTowns_Wales'),
    (['cornwall'], 'OSTowns_Cornwall'),
    (['isle of man'], 'OSTowns_Isle_of_Man'),
    (['lancashire', 'yorkshire', 'cheshire', 'cumberland', 'westmorland', 'durham', 'northumberland'], 'OSTowns_North'),
    (['lincolnshire', 'derbyshire', 'leicestershire', 'nottinghamshire', 'northamptonshire', 'rutland', 'huntingdonshire'], 'OSTowns_Midlands_east'),
    (['staffordshire', 'warwickshire', 'worcestershire', 'shropshire', 'herefordshire', 'gloucestershire'], 'OSTowns_Midlands_west'),
    (['kent', 'sussex', 'hampshire', 'surrey', 'essex', 'suffolk', 'norfolk', 'dorset', 'devon', 'somerset', 'wiltshire', 'berkshire', 'oxfordshire','buckinghamshire', 'hertfordshire', 'cambridgeshire', 'bedfordshire', 'middlesex', 'no county'], 'OSTowns_South'),
]:
    for k in name:
...
# save output data
metadata.to_file("./data/metadata_ostowns_500_with_xyz.json", driver="GeoJSON", engine="pyogrio")
